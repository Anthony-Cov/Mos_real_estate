...
def price():
    ...
    #['planchers_sur', 'superficie_tot', 'lon', 'lat', 'metroprox', 'rwprox','medprox', 'kidprox', 'schoolprox', 'cemetprox', 'industrprox','liveratio', 'highratio']
    ...
    result=pd.DataFrame({'Горизонт прогноза':horizon,
                         ...
                         'Цена за метр на текущую дату':[price_pure]*len(horizon),
    ...
    #                            , , , resp]], 
    #                     columns=['Широта', 'Долгота', 'количество этажей всего','общая площадь объекта','жилая площадь объекта',
