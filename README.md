...
## 1. Комплект поставки.
<B>M_Price_2_5.py</B> - прогнозирование/эксплуатация с запросом API обновлённая версия. Изменения касаются формата вывода результатов. Дальнейшее описание соответсвует этой версии (Обновлена, исправлена для работы с моделью GBoost25_2с.pkl.<BR>
