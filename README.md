...
<pre>
	...
	"pricemetr25": 137.83, # рассчитанная цена кв. метра в тысячах рублей на конец II квартала 2025
	"pricemetr_dom": 159.29, # цена кв. метра в тысячах рублей на заданный горизонт по индексу Домклик
	"pricemetr_off": 151.26, # цена кв. метра в тысячах рублей на заданный горизонт по Распоряжению № ДПР-Р-34.24 28.12.2024
	"response": "Okay"
	}
 </pre>
Код завершения: 
...
------------+-----------+---------------+---------------+---------------+-----------+---------------+-----------+-------------------+---------------+---------------+------------
|55.7965029	|37.61191755|56				|38910.0		|22301.0		|2.0		|1.097			|1.156		|137.83				|159.28			|151.26			|Okay		|
------------+-----------+---------------+---------------+---------------+-----------+---------------+-----------+-------------------+---------------+---------------+------------
</pre>
