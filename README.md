...
(Упрощенный вариант с выводом прогноза поквартально на двухлетний горизонт 2.4)
...
<pre>
{
  ...
  "pricemetr_future_dom": 344.1,
  "pricemetr_future_off": 301.12,
  "pricemetr_off": [
    446.88,
    453.35,
    458.1,
...
"pricemetr_future_dom": 344.1,   "pricemetr_future_off": 301.12, - прогноз цены кв. метра на заданный горизонт по индексам Домклик и Департамента соответственно.
